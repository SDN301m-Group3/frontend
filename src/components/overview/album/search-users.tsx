...
import { getUsers, inviteUserToAlbum } from '@/lib/action';
...
export function SearchUsers({ albumId }: { albumId: string }) {
    ...
    const handleInvite = async () => {
        setIsLoading(true);
        // send invite
        const result = await inviteUserToAlbum(albumId, value);
        if (!result?.isSuccess) {
